...
bool j1Scene::Start()
{
	if (!start_game)
	{
		...
		inputbox_gui = (GUIInputBox*)App->gui->CreateGUIInputBox(GUI_ELEMENT_TYPE::GUI_INPUTBOX, 100.0f, 50.0f, "Testtttttttttttttttt", { 0, 0, 0, 255 }, App->gui->default_font_used, { 0, 0, 100, 21 });
	}
